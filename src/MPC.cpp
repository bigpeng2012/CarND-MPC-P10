...
// fg[ cost function[0],[initial val x, constraints *(N)],[initial val y, constrains*(N)],[ psi...],[v...],[cte...],[epsi...] ]
//constraints_upperbound
//constraints_lowrbound


// vars[[initial x state vars, 0,0,0,0....(N-1)],[y..],[psi ...],[v...],[cet...],[cpsi...], [actuator vars steering angle 0,0,0....*(N-1)], [actuator vars accelarator 0,0,0...*(N-1).]] 
// vars_upperbound
// vars_lowerbound
...
// setting up vehicle model constraints and variables for Ipopt
// Ipopt expects all constraints and vars are vectors
std::vector<double> MPC::Solve(const VectorXd &state, const VectorXd &coeffs) {
	...
	//vars include states and actuators 
	Dvector vars(n_vars);  
	...
	// Set all non-actuators (six states) upper and lower limits
	...
	// Set up initial state for constraints, similar to set vars initial

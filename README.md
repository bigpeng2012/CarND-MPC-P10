...
### libcoinmumps - missing dependency error
```
./mpc: error while loading shared libraries: libcoinmumps.so.1: cannot open shared object file: No such file or directory
```
1. Download the [file](https://forge.scilab.org/index.php/p/sci-ipopt/source/tree/87d40abff2e10dfa799dab2962e52179a2596cc1/thirdparty/Linux/lib/x64)

2. Drop it to /Ipopt-3.12.7/ThirdParty/Mumps
